 ...
 */
final readonly class Any implements RuleInterface
{
    ...
    public function check(mixed $subject): RuleEvaluation
    {
        ...
        return $firstAnswer ?? throw new \InvalidArgumentException(
            'Any rule engine must have at least one rule to evaluate.'
        );
    }
}
